      ...
      return (
        <div className="flex flex-col h-screen bg-chibangarx-bg text-chibangarx-text items-center justify-center p-8">
          ...
          <div className="max-w-xl w-full rounded-2xl border border-chibangarx-border bg-chibangarx-card p-8">
            <h1 className="text-2xl font-semibold text-red-500 mb-2">{i18n.t("errorBoundary.title")}</h1>
            ...
            <p className="text-sm text-chibangarx-text-muted">
                {i18n.t("errorBoundary.createIssue")}{" "}
              <a
                href={GITHUB_ISSUES}
                target="_blank"
              ...
              >
                {i18n.t("errorBoundary.githubIssue")}
              </a>{" "}
                {i18n.t("errorBoundary.orShareError")}{" "}
              <a
                href={DISCORD_INVITE}
                target="_blank"
                rel="noopener noreferrer"
